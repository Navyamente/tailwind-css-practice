                        ...
                        <div className="flex flex-col space-y-12 rounded-sm p-6">
                            <div className="flex w-full max-w-sm flex-col items-center justify-center p-6 md:-mt-6 ">
                                <div className="flex w-full flex-col space-y-6 p-5">
                                    <img className="flex h-12 w-14 rounded-md items-center justify-center -mt-6 -ml-4"
                                        src={userprofile} alt="Design" />
                                </div>
                                <div className="-ml-14">
                                    <p className="text-sm font-semibold font-medium -mt-16">Fitbit Incoporation</p>
                            ...
                            <div className="flex flex-col items-start justify-start md:w-1/3 ml-8 ">
                                <h1 className="text-base font-bold -mt-16">User Experience Revamp</h1>
                                <p className="text-xs mt-8">To many naive users of the platform,a reddesign may look just like a facelift.No more, no less.However, for a User Experience designer,the entire redesign process means much more than a lot of research,meticulous planning,iterating and gallons of coffee.</p>
                            </div>
                            <div
                                className="w-9 h-6 mb-3 -mt-16 ml-24 rounded-full flex items-center justify-center">
                                <img className="w-8 h-6 rounded-full"
                                    src={participants} alt="" />
                                <img className="w-8 h-6 rounded-full -ml-1"
                                    src={participants} alt="" />
                                <img className="w-8 h-6 rounded-full -ml-1"
                                    src={participants} alt="" />
                                <img className="w-8 h-6 rounded-full -ml-1"
                        ...
                        <div className="flex w-full max-w-sm flex-col items-center justify-center p-6 md:-mt-32 ">
                            <div className="flex w-full flex-col space-y-6 p-5">
                                <div className="flex flex-col space-y-6 text-center md:flex-row md:space-x-4 md:space-y-0">
                                    <div className="flex justify-center rounded-sm bg-blue-100 p-2 font-semibold text-blue-800">Start Date: 22 Jun, 2020</div>
                                    <div className="flex justify-center rounded-sm bg-red-100 p-2 font-semibold text-red-800">End Date: 03 Dec, 2020</div>
                                </div>
                            ...
                            <div className="flex mx-auto items-start p-2 space-x-8">
                                ...
                                <div className="mx-4">
                                    <h2 className=" text-lg leading-6 text-center font-semibold">03</h2>
                                    <p className="text-xs font-semibold">Teams Assigned</p>
                                </div>
                                <div className>
                                    <h2 className=" text-lg leading-6 text-center font-semibold">14</h2>
                        ...
                        <div className="flex flex-col space-y-12 p-6 shadow-md">
                            <div className="flex flex-col space-y-6">
                                <div className="flex justify-between">
                                    <div className="flex font-normal">User Experience Research</div>
